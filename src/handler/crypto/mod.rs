...
use hkdf::{hmac::digest::Update, Hkdf};
...
mod tests {
    ...
    fn ref_test_ecdh() {
        ...
        let local_sk =
            k256::ecdsa::SigningKey::from_bytes(GenericArray::from_slice(&local_secret_key))
                .unwrap();
    ...
    fn ref_key_derivation() {
        ...
        let local_sk =
            k256::ecdsa::SigningKey::from_bytes(&GenericArray::from_slice(&ephem_key)).unwrap();
    ...
    fn ref_nonce_signing() {
        ...
        let key = k256::ecdsa::SigningKey::from_bytes(GenericArray::from_slice(&local_secret_key))
            .unwrap();
